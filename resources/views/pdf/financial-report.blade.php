...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .col-acct   { width: 12%; white-space: nowrap; }
        .col-name   { width: 20%; }
        .col-course { width: 32%; }
        .col-amt    { width: 14%; }
        .col-bal    { width: 12%; }
...
<body>
    ...
    <div class="section-title">
        Student Account Status &mdash; {{ $semester }} &bullet; {{ $schoolYear }}
    </div>
        ...
        <tbody>
            @forelse($students as $student)
                <tr>
                    ...
                    <td class="col-bal text-right" style="{{ $student['balance'] <= 0 ? 'color:#059669; font-weight:700;' : 'color:#dc2626; font-weight:700;' }}">
            ...
            @empty
                <tr>
                    <td colspan="6" class="empty">
                        No students assessed for {{ $semester }} {{ $schoolYear }}.
                    </td>
                </tr>
            @endforelse
        </tbody>
